...
clock: Tk = Tk()
clock.title("STEPHEN ALARM CLOCK")

clock.geometry("400x200")
time_format=Label(clock, text= "Enter time in 24 hour format!", fg="green",bg="white",font="Arial").place(x=60,y=120)
addTime = Label(clock,text = "Hour  Min   Sec",font=60,fg='green').place(x = 110)
setYourAlarm = Label(clock,text = "wake up time",fg="green",relief = "solid",font=("Helevetica",7,"bold")).place(x=0, y=29)
